      ...
      ">
        <div style="width:400px;height:400px;padding:2em;overflow:auto">
          <div style="width:${options.horizontal ? '800px' : 'auto'}">
            ...
            <p>
              Curabitur dapibus in mi quis fermentum. Nam mauris nisi, porta
              nec sollicitudin quis, fermentum nec elit. Cras sit amet ligula
              nisl. Maecenas dictum mauris ullamcorper, dictum massa quis,
              ullamcorper nibh. Praesent molestie justo a magna porta, sed
              dapibus diam varius. Sed facilisis condimentum elit, eget blandit
              enim dignissim sed. Etiam bibendum lacinia metus aliquet mollis.
              Aenean aliquet ligula nec urna laoreet, eu efficitur orci
              pretium. Aenean consequat, sapien vitae finibus laoreet, eros
              metus cursus velit, non tincidunt elit lacus a neque. Nullam
              consectetur risus vel ipsum suscipit semper. Sed vitae
              sollicitudin metus. Class aptent taciti sociosqu ad litora
              torquent per conubia nostra, per inceptos himenaeos. Curabitur
              varius non ex ac eleifend. Pellentesque rhoncus placerat arcu, a
              ultricies mi.
            </p>
            <p>
              ...
              netus et malesuada fames ac turpis egestas. Phasellus augue
              neque, dictum id lacus nec, pharetra pretium velit. Class aptent
            ...
            <p>
              ...
              porttitor urna nibh, sit amet rhoncus felis pretium id. Interdum et
              malesuada fames ac ante ipsum primis in faucibus. Morbi viverra
